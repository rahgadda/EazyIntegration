...
# -- Test docker file
docker run -d -p 8080:8080 -p 8888:8888  --name test-eazyintegration rahgadda/eazyintegration "camel run /workspace/EazyIntegration/route/remote-post-http.yaml"
